...
const messages: Record<Lang, Record<string, string>> = {
  zh: {
    ...
    'settings.gap': '间距',
    'settings.content_margin_x': '内容边距',
    'settings.content_margin_x_hint': '内容展示区域左右两侧的空白边距',
    ...
    'settings.skip_empty_folders': '空文件夹不扫描为子节点',
    'settings.skip_empty_folders_hint': '勾选后扫描文件夹时跳过完全无图片的空文件夹，不会在目录树中显示为子节点；默认关闭，空文件夹也会显示为子节点',
    ...
    'settings.random_group': '随机分组',
    'settings.random_group_enable': '启用随机分组',
    'settings.random_group_hint': '开启后，文件夹节点和虚拟分组节点的右键菜单中显示「随机抽取为新分组」',
    'settings.random_group_count': '默认抽取数',
    'settings.random_group_count_hint': '打开随机抽取对话框时默认填入的数量，超过节点内图片总数时以总数为准',
    ...
    'folder.random_extract': '随机抽取为新分组',
    ...
    'hint.random_extract_title': '随机抽取为新分组',
    'hint.random_extract_total': '节点内共 {n} 张图片',
    'hint.random_extract_count': '随机抽取数',
    'hint.random_extract_empty': '节点内没有图片',
    'hint.random_extracted': '已随机抽取 {n} 张图片到「{name}」',
  ...
  en: {
    ...
    'settings.gap': 'Gap',
    'settings.content_margin_x': 'Content Margin',
    'settings.content_margin_x_hint': 'Blank margin on left/right sides of the content area',
    ...
    'settings.skip_empty_folders': 'Skip empty folders as child nodes',
    'settings.skip_empty_folders_hint': 'When checked, empty folders without images are skipped and not shown as child nodes in the tree; by default (off) empty folders are shown as child nodes',
    ...
    'settings.random_group': 'Random Group',
    'settings.random_group_enable': 'Enable Random Group',
    'settings.random_group_hint': 'When enabled, "Random Extract as New Group" is shown in the context menu of folder and virtual group nodes',
    'settings.random_group_count': 'Default Extract Count',
    'settings.random_group_count_hint': 'Default count filled in the extract dialog; capped by the total number of images in the node',
    ...
    'folder.random_extract': 'Random Extract as New Group',
    ...
    'hint.random_extract_title': 'Random Extract as New Group',
    'hint.random_extract_total': '{n} images in this node',
    'hint.random_extract_count': 'Extract count',
    'hint.random_extract_empty': 'No images in this node',
    'hint.random_extracted': 'Extracted {n} random images into "{name}"',
